...
path_to_save_png = "./output_png/"
path_to_save_csv = "./output_csv/"
...
def data_to_graph(x_available, Re, path_to_lethe_data, file_names_lethe_data, path_to_literature_data, path_to_save_png, path_to_save_csv,
                  lebels, extra):
    file_nb = 0
...
data_to_graph(x_available, Re, path_to_lethe_data, file_names_lethe_data, path_to_literature_data,
              path_to_save_png + name_to_save,path_to_save_csv + name_to_save,  labels, extra)
